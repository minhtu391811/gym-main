...
export interface ServicesDateSingleInputProps {
...
const ServicesDateSingleInput: FC<ServicesDateSingleInputProps> = ({
  defaultValue,
  onChange,
  defaultFocus = false,
  onFocusChange,
  ...
  return (
    <div
      className={`ServicesDateSingleInput relative flex ${className} ${
...
export default ServicesDateSingleInput;
