            ...
            <div class="flex-1 mt-6 xl:mt-0">
              <div class="grid grid-cols-12 gap-x-5">
                <div class="col-span-12 2xl:col-span-6">
                  <div>
                    <div class="flex items-center form-label">
                      <div class="font-medium">Tên huấn luyện viên</div>
                ...
                <div class="col-span-12 2xl:col-span-6">
                  ...
                  <div class="mt-3 ">
                    <div class="flex items-center form-label">
                      <div class="font-medium">Chuyên môn</div>
                    </div>
                    <input v-model="formData.specialty" type="text" class="form-control" />
                  </div>

                  <div class="mt-3 ">
                    <div class="flex items-center form-label">
                      <div class="font-medium">Kinh nghiệm</div>
                    </div>
                    <input v-model="formData.experience" type="text" class="form-control" />
                  </div>
...
const props = defineProps(['formData', 'newImage',]);
